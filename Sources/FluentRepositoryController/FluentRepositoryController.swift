//
//  FluentRepositoryController.swift
...
open class RepositoryController<R>: FluentRepositoryController where R: FluentRepository, R.DBModel: Content, R.DBModel: Parameter, R.DBModel.ResolvedParameter == Future<R.DBModel>, R: Service {
